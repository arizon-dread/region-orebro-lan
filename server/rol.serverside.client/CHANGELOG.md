...
- Create Angular project with ng: `ng new rol.serverside.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`rol.serverside.client.esproj`).
